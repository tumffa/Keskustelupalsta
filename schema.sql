...
CREATE TABLE responses (id SERIAL PRIMARY KEY, comment_id INTEGER REFERENCES comments ON DELETE CASCADE, user_id INTEGER REFERENCES users ON DELETE CASCADE, username TEXT, respondsto TEXT, description TEXT DEFAULT '', date TEXT);
